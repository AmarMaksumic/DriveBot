...
from rosboard.handlers import ROSBoardSocketHandler, NoCacheStaticFileHandler, AddPoseHandler, SaveMapHandler, StartMapHandler, make_launch_queue, GetMapListHandler, DeletMapFileHandler
class ROSBoardNode(object):
    ...
    def __init__(self, node_name = "rosboard_node"):
        ...
        tornado_handlers = [
                ...
                (r"/xgo/addpose", AddPoseHandler),
                (r"/xgo/savemap", SaveMapHandler),
                (r"/xgo/getmap", GetMapListHandler),
                (r"/xgo/deletmap", DeletMapFileHandler),
                (r"/xgo/startmap", StartMapHandler, dict(queue_functions=make_launch_queue())),
